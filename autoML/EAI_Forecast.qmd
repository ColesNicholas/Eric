...
# remove anything we wouldn't have for future
df <- df %>% 
  select(-c(
    rto_combined_net_load_forecast_bid_close_average,
    ...
    henry_gasprice_average, tetco_m3_gasprice_average,
...
# Add lags of y and all exogenous vars
```{r}
lags <- c(7, 8, 9, 365, 366)
